    ...
    <div className="w-[16vw] h-[92vh] p-6 shadow-md">
      <div className="flex flex-col gap-4">
        ...
        <div className="h-[80vh] flex flex-col gap-4">
          <div className="flex items-center gap-4 bg-slate-100 w-[90%] p-2 rounded-sm cursor-pointer">
            <img src="home.svg" />
            <p onClick={()=>setDashboard(0)} className="font-Roboto text-[14px] text-[#FF4500] font-medium">
              Community
            </p>
          </div>
          <div className="flex items-center gap-4 w-[90%] p-2 rounded-sm cursor-pointer">
            <img src="jobs.svg" />
